/*	LissajousCurve.java
	...
	This class draws Lissajous curves, a generalization of the parametric equations
...
public class LissajousCurve extends JFrame implements MouseListener, KeyListener
{
	...
	{
		LissajousCurve app = new LissajousCurve();
