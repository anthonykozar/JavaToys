/*	Lituus.java
	...
	Draws a lituus, "a spiral in which the angle is inversely proportional 
	to the square of the radius" (Wikipedia).  The arm of the lituus is 
	asymptotic to the x-axis and it's equation is r^2 = a/theta.
